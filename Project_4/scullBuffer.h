...
struct scull_buffer {
  ...
  struct semaphore semaphore_rw;  /* semaphore for read and write */
  struct semaphore semaphore_dev; /* semaphore for dev */
  struct semaphore semaphore_empty; /* semaphore */
  struct semaphore semaphore_full; /* semaphore */
  int *itemSizePtr; /* size for each item */
  int nextItem; /* */
  int numItems; /* */
};
