...
{
	// cout << "Relative Block number: " << relativeBlockNumber << endl;
	// check for the maximum block number using getMaxBlockNumber()
	if(relativeBlockNumber >= fileSystem->getMaxBlockNumber())
	{
